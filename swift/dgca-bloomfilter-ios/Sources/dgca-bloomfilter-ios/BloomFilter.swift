...
public class BloomFilter {
	...
	private var definedElementAmount: UInt16 = 0
	...
	public func readFrom(stream: Data) throws {
		...
		definedElementAmount = UInt16(stream.withUnsafeBytes {$0.load(as: UInt16.self)})
		currentElementAmount = UInt16(stream.withUnsafeBytes {$0.load(as: UInt16.self)})
