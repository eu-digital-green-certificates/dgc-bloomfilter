...
package eu.europa.ec.dgc.bloomfilter.model;
...
public class FilterTestData {
    ...
    public FilterTestData setFilterAsBase64(String filterAsBase64) {
        if (filterAsBase64 == null || filterAsBase64.length() == 0) { throw new IllegalArgumentException(); }
    ...
    public FilterTestData setWritten(int[] written) {
        if (written == null || written.length == 0) { throw new IllegalArgumentException(); }
    ...
    public FilterTestData setRawBit(boolean[] rawBit) {
        if (rawBit == null) { throw new IllegalArgumentException(); }
        this.rawBit = rawBit;
        return this;
    }
    //endregion
